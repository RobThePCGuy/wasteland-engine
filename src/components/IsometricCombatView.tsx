                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative">
                    <CharacterSprite 
                      ...
                      equipment={
                        actor.type === 'player' 
                          ? gameState?.inventory?.find((i: any) => i.id === actor.equipped_weapon_id)?.name || 
                            gameState?.inventory?.find((i: any) => i.id === actor.equipped_armor_id)?.name || ''
                          : actor.equipped_weapon_name || actor.equipped_armor_name || ''
                      }
                    />
